...
local Library do
    ...
    local Themes = {
		["Preset"] = {
			["Background"] = FromRGB(12, 14, 12),
			["Border"] = FromRGB(28, 32, 28),
			["Inline"] = FromRGB(30, 34, 30),
			["Hovered Element"] = FromRGB(55, 62, 50),
			["Page Background"] = FromRGB(18, 20, 18),
			["Outline"] = FromRGB(65, 74, 60),
			["Element"] = FromRGB(36, 42, 35),
			["Gradient"] = FromRGB(200, 240, 180),
			["Text"] = FromRGB(240, 245, 230),
			["Text Stroke"] = FromRGB(0, 0, 0),
			["Placeholder Text"] = FromRGB(165, 175, 160),
			["Accent"] = FromRGB(169, 242, 112)
		}
    }
    ...
    Library.SetFont = function(self, FontId)
        local NewFont = Font.new("rbxassetid://" .. tostring(FontId))
        Library.Font = NewFont

        for _, Item in Library.Holder.Instance:GetDescendants() do
            if Item:IsA("TextLabel") or Item:IsA("TextButton") or Item:IsA("TextBox") then
                Item.FontFace = NewFont
            end
        end
    end
    ...
    local Components = { } do
        ...
        Components.ImageButton = function(self, Data)
            local Button = { }
            ...
            function Button:Add(Name, Icon, Callback)
                local NewButton = { }
                ...
                local SubItems = { } do
                    ...
                    SubItems["Icon"] = Instances:Create("ImageLabel", {
                        ...
                        BorderColor3 = FromRGB(0, 0, 0),
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  SubItems["Icon"]:AddToTheme({ImageColor3 = "Accent"})
        ...
        Components.Divider = function(self, Data)
            local Divider = { }
            ...
            local Items = { } do
                ...
                Items["Line"] = Instances:Create("Frame", {
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(65, 74, 60)
                ...
                if Data.Name and Data.Name ~= "" then
                    Items["Text"] = Instances:Create("TextLabel", {
                        ...
                        Name = "\0",
                        FontFace = Library.Font,
                        TextColor3 = FromRGB(165, 175, 160),
                        BorderColor3 = FromRGB(0, 0, 0),
                        Text = Data.Name,
                        AnchorPoint = Vector2New(0.5, 0.5),
                        Position = UDim2New(0.5, 0, 0.5, 0),
                        BackgroundColor3 = FromRGB(36, 42, 35),
                        BackgroundTransparency = 0,
                        BorderSizePixel = 0,
                        AutomaticSize = Enum.AutomaticSize.X,
                        TextSize = 13,
                        TextScaled = true,
                    })  Items["Text"]:AddToTheme({TextColor3 = "Placeholder Text", BackgroundColor3 = "Element"})
        ...
        Components.Progress = function(self, Data)
            local Progress = {
                Flag = Data.Flag,
            ...
            local Items = { } do
                ...
                Items["Track"] = Instances:Create("Frame", {
                    ...
                    BorderSizePixel = 2,
                    BackgroundColor3 = FromRGB(30, 36, 31)
                })  Items["Track"]:AddToTheme({BackgroundColor3 = "Element", BorderColor3 = "Border"})
                ...
                Items["Fill"] = Instances:Create("Frame", {
                    ...
                    Size = UDim2New(0, 0, 1, 0),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(169, 242, 112)
                })  Items["Fill"]:AddToTheme({BackgroundColor3 = "Accent"})

                Items["ValueLabel"] = Instances:Create("TextLabel", {
                    Parent = Items["Track"].Instance,
                    Name = "\0",
                    FontFace = Library.Font,
                    TextColor3 = FromRGB(235, 235, 235),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Text = tostring(Progress.Value) .. (Data.Suffix or ""),
                    ...
                    ZIndex = 2,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })  Items["ValueLabel"]:AddToTheme({TextColor3 = "Text"})

                Items["ValueLabel"]:TextBorder()
            end

            function Progress:Set(Value)
                Progress.Value = MathClamp(Value, Progress.Min, Progress.Max)
                Library.Flags[Progress.Flag] = Progress.Value
                local FillScale = (Progress.Value - Progress.Min) / (Progress.Max - Progress.Min)
                Items["Fill"]:Tween(TweenInfo.new(Library.Tween.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2New(FillScale, 0, 1, 0)})
                Items["ValueLabel"].Instance.Text = tostring(Progress.Value) .. (Data.Suffix or "")
            end
    ...
    Library.Window = function(self, Data)
        ...
        local Items = Components:Window({
            ...
            Items["Logo"] = Instances:Create("ImageLabel", {
                ...
                BackgroundTransparency = 1,
                Position = UDim2New(0.5, 0, 0, Window.Name ~= "" and 28 or 12),
            ...
            Items["Pages"] = Instances:Create("Frame", {
                ...
                Name = "\0",
                BackgroundTransparency = 1,
                Position = UDim2New(0, 0, 0, Window.Name ~= "" and 116 or 100),
                BorderColor3 = FromRGB(0, 0, 0),
                Size = UDim2New(1, 0, 1, Window.Name ~= "" and -151 or -135),
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(255, 255, 255)
            })
    ...
    Library.Sections.ImageButton = function(self)
        local Button = {
            Window = self.Window,
            Page = self.Page,
            Section = self
        ...
        local NewButton, ButtonItems = Components:ImageButton({
            Parent = Button.Section.Items["Content"],
            Page = Button.Page
        })
    ...
    Library.Sections.Divider = function(self, Name)
        local NewDivider, DividerItems = Components:Divider({
    ...
    Library.Sections.Progress = function(self, Data)
        Data = Data or { }
    ...
    Library.MobileToggle = function(self, Window, Icon)
        if not Icon then
            return
        end

        local MobileGui = Instances:Create("ScreenGui", {
            Parent = gethui(),
            Name = "\0",
            ZIndexBehavior = Enum.ZIndexBehavior.Global,
            DisplayOrder = 3,
        ...
        local Button = Instances:Create("ImageButton", {
            Parent = MobileGui.Instance,
            Name = "\0",
            Image = "rbxassetid://" .. tostring(Icon),
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
			...
			local SettingsSubPage = SettingsPage:SubPage({Name = "Settings", Columns = 2}) do
			    local SettingsSection = SettingsSubPage:Section({Name = "Settings", Side = 1}) do
			        SettingsSection:Toggle({
			            ...
			            Default = true,
			            Callback = function(Value)
			                if Watermark then Watermark:SetVisibility(Value) end
			            end
			        })
			        ...
			        SettingsSection:Toggle({
			            ...
			            Default = true,
			            Callback = function(Value)
			                if KeybindList then KeybindList:SetVisibility(Value) end
			            end
			        })
